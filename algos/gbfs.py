...
def gbfs(grid, track: Track) -> Track:
    ...
    while track.open_list:
        ...
        for dx, dy in directions:
            ...
            heuristic: int = abs(next_x - track.end.position[0]) + abs(next_y - track.end.position[1])
            child_node = current_node.add_child_heuristic(heuristic, (next_x, next_y))
